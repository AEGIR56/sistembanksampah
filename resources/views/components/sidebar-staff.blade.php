    ...
    <div class="offcanvas-body d-flex flex-column bg-dark text-white p-0" style="height: 100vh; width: 100%;">
        ...
        <div class="flex-grow-1 overflow-auto pt-3 px-3">
            ...
            <a href="{{ route('staff.dashboard') }}"
                class="nav-link mb-2 d-flex align-items-center px-3 py-2 rounded {{ request()->routeIs('staff.dashboard') ? 'bg-white bg-opacity-10 text-white fw-bold' : 'text-white' }}"
            ...
            <a href="{{ route('staff.pickups.index') }}"
                class="nav-link mb-2 d-flex align-items-center px-3 py-2 rounded {{ request()->routeIs('staff.pickups') ? 'bg-white bg-opacity-10 text-white fw-bold' : 'text-white' }}"
                style="transition: all 0.3s;">
